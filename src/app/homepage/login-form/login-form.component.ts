import { AcceptedAppointmentService } from './../../services/accepted.appointment.service';
...
export class LoginFormComponent implements OnInit {
  ...
  constructor(
    ...
    private acceptedService: AcceptedAppointmentService
  ) {}
  ...
  ngOnInit() {
    ...
    this.acceptedService.getAllergies().subscribe({
      next: (res) => {
        console.log(res);
